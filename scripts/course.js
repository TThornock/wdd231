...
const container = document.querySelector('#courses-set');
...
function displayCourses(courseList) {
    ...
    courseList.forEach(course => {
        ...
        box.classList.add(course.completed ? 'completed' : 'incomplete');
        
        const status = course.completed ? '✅' : '';
        box.textContent = `${status} ${course.subject}${course.number}`;
...
wddBtn.addEventListener('click', showWDD);
cseBtn.addEventListener('click', showCSE);
